      ...
      <div class="col-lg-12 col-md-12 col-12 mb-4">
        <div class="card">
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="d-flex">
                <h5 class="card-header">{{ $weeklySchedule->title }}</h5>
              </div>
          ...
          <div class="table-responsive text-nowrap">
            <table class="table">
              ...
              <tbody>
                @forelse ($weeklySchedule->masterSchedules as $index => $masterSchedule)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $masterSchedule->homeTeam->name }}</td>
                        <td>{{ $masterSchedule->awayTeam->name }}</td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <form action="{{ route('masterschedules.destroy', $masterSchedule->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
